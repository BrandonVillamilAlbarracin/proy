...
exports.SQL_ESTUDIANTE_CRUD = void 0;
exports.SQL_ESTUDIANTE_CRUD = {
    ...
    VERIFICAR: "SELECT COUNT(documento) AS cantidad FROM estudiantes a WHERE lower(a.nombre) = lower($1)"
};
